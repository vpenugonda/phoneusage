...
import edu.fairfield.phoneusage.models.classes.VoiceVoter;
import edu.fairfield.phoneusage.utils.Context_Service;
import edu.fairfield.phoneusage.utils.UsageService;
import edu.fairfield.phoneusage.views.ActionTabsViewPagerAdapter;
import edu.fairfield.phoneusage.views.SlidingTabLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_history) {
            ...
            Intent i = new Intent(MainActivity.this, edu.fairfield.phoneusage.tracker.MainActivity.class);
            startActivity(i);
    ...
    private void setupTabs() {
        ...
        //slidingTabLayout.setBackgroundColor(Color.GREEN);
